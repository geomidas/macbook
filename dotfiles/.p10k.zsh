# Generated by Powerlevel10k configuration wizard on 2020-07-20 at 09:00 IST.
...
() {
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=8
  ...
  # You can define different colors, icons and content expansions for different classes:
  #
  typeset -g POWERLEVEL9K_AWS_PROD_FOREGROUND=8
  typeset -g POWERLEVEL9K_AWS_PROD_BACKGROUND=214
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      '*build*' BUILD
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=8
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=8
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=4
