# Generated by Powerlevel10k configuration wizard on 2022-06-13 at 18:06 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=038
  ...
  typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_BACKGROUND=197
  ...
  typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_BACKGROUND=125
  ...
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=214
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${AWS_PROFILE}'
  ...
  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND=234
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=032
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=031
